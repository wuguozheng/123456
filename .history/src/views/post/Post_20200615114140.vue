<template>
  <div>
    ...
    <div class="d-f">
      <div class="d-f a-i-c">
        <div class="gun">作者</div>
        <el-input v-model="author" class="ipt"></el-input>
      </div>
      <div class="d-f a-i-c">
        <div class="gun">类目</div>
        <el-select v-model="category" placeholder="请选择" class="ipt">
          <el-option
