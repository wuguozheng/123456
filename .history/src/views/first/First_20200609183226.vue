  ...
  <div>
    <el-container>
      <el-header  class="toni d-f j-c-s-b">
          ...
          <span>{{two}}{{obj.username}}上次登录时间:{{time}}</span>
      </el-header>
      <el-container>
...
export default {
  ...
  data() {
    return {
        list:[
            ...
            {name:'退出',log:'el-icon-delete-solid',index:'8'},
        ],
        obj:{},
        item:'',
        two:{}
  ...
  mounted() {
        ...
        this.two=dayjs(this.obj.date).format('HH')
        if(two>5 && two<=12) {
            this.two='早上好,兄弟'
        } else if(two>12 && two<=16){
            this.two='中午好,兄弟'
        } else if(two>16 && two<=20){
            this.two='下午好,兄弟'
        } else if(two>20 && two<=24){
            this.two='晚午好,兄弟'
        } else{
            this.two='该睡觉了,兄弟'
        }
