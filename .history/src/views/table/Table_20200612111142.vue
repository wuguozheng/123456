    ...
    <div>
      <el-card class="box-card m-t2">
        ...
        <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
          <div class="m-t2 f-s20">名称 : <input type="text" class="hn"></div>
          <div class="m-t2 f-s20">原价 : <input type="text" class="hn"></div>
          <div class="m-t2 f-s20">现价 : <input type="text" class="hn"></div>
